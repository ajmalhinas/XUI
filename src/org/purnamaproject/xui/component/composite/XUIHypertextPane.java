...
/**
 * @(#)XUIHypertextPane.java    0.5 18/08/2003
 *
...
/**
 * This component represents a hypertext pane (i.e. HTML window).
 *
 * @version    0.5 18/08/2003
 * @author     Arron Ferguson
 */
public interface XUIHypertextPane extends XUIComponent, XUIEventSource
{
