...
/**
 * The abstraction of a XUI atomic component. It contains base attributes of the XUI atomic components.
 *
 * @version    0.5 18/08/2003
 * @author     Arron Ferguson
 */
public interface XUIAtomic extends XUIComponent
{
    /**
