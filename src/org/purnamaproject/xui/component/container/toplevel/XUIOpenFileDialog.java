...
/**
 * @(#)XUIOpenFileDialog.java    0.5 18/08/2003
 *
...
/**
 * The abstraction of a XUI OpenFileDialog. Allows the user to graphically select and open a
 * file from a list presented. If any listeners are registered with this component
 * they will be given a reference to the file.
 *
 * @version    0.5 18/08/2003
 * @author     Arron Ferguson
 */
public interface XUIOpenFileDialog extends XUIContainer, XUITopLevelContainer, XUIEventSource
{
    /**
    ...
    /**
     * Returns the selected file as a URL
     *
