...
/**
 * @(#)XUITextAreaImpl.java 0.5 18/08/2003
 *
...
/**
 * The implementation of the XUITextArea interface.
 *
 * @version 0.5 18/08/2003
 * @author  Arron Ferguson
 */
public class XUITextAreaImpl implements XUITextArea, CaretListener
{
    /**
    ...
    /**
     * <p>Constructs a new XUITextArea implementation and passing it its XML node rather than requiring
     * the XUITextArea implementation to build it from scratch. This method is called by the Realizer
     ...
     * This constructor is required when creating a XUI text area where the node has already been built
     ...
     */
    public XUITextAreaImpl(XUINode node) throws XUIDisplayException
    {
        ...
        if(!(node.getName().equals("TextArea")))
            throw new XUIDisplayException("Node for XUITextArea must be named 'TextArea' and conform to the XUI schema.");
        else
        {
            // gui component
            field = new JTextArea(1, 15);
            field.setEnabled(Boolean.valueOf(node.getAttributeValue("enabled")).booleanValue());
            scroller = new JScrollPane(field);

            fieldNode = node;
            fieldNode.setXUIComponent(this);
            ...
            // get text
            List text = fieldNode.getChildNodesByName("Text");
            XUINode textNode = (XUINode)text.get(0);
            field.setText(textNode.getCDATA());

        }
    }

    /**
     * Creates a text area. Default size is 1 x 1 cells in the top left corner.
     */
    public XUITextAreaImpl()
    {
        // gui component
        field = new JTextArea(1, 15);
        scroller = new JScrollPane(field);
        ...
        fieldNode = new XUINodeImpl("TextArea");
        fieldNode.setLevel(4);
        fieldNode.addNamespace("xui", "http://xml.bcit.ca/PurnamaProject/2003/xui");
        fieldNode.setXUIComponent(this);

        // add specific attributes
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "id", "id", "xs:ID",
            IDFactory.getInstance().generateID("textarea"));
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "x", "x", "xs:unsignedShort",
            "0");
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "y", "y", "xs:unsignedShort",
            "0");
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "width", "width", "xs:unsignedShort",
            "1");
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "height", "height", "xs:unsignedShort",
            "1");
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "enabled", "enabled",
            "xs:boolean", "true");
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "scrolling", "scrolling",
            "xs:token", "horizontal");


        XUINode textNode = new XUINodeImpl("Text");
        textNode.setLevel(5);
        fieldNode.addChildNode(textNode);

    }

    /**
     * Creates a text area and gives it x and y coordinates. If the area field has a parent,
     * then the text area will be placed at that position. The x and y values must be within the XUI
     ...
     */
    public XUITextAreaImpl(int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        this();
    ...
    /**
     * Creates a text area and gives it x and y coordinates and scrolling. If the text area has a parent,
     * then the text area will be placed at that position. The x and y values must be within the XUI
     * schema specification as well, be placed on the panel and not overtop of any other component.
     * If so, an exception is generated.
     *
     ...
     */
    public XUITextAreaImpl(int xCoordinate, int yCoordinate, int scrollChoice) throws XUIDisplayException
    {
    ...
    public void setEnabled(boolean enabled)
    {
        ...
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "enabled", "enabled", "xs:boolean",
            "" + field.isEnabled());
    }
    ...
    public String getID()
    {
        return fieldNode.getAttributeID();
    }
    ...
    public void setComponentLocation(int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        ...
        else
        {
            ...
            XUINode parentNode = fieldNode.getParent();
            if(parentNode != null)
    ...
    /**
     * Called when the caret within the text area moves around.
     */
