...
/**
 * @(#)XUISaveFileDialogImpl.java   0.5 18/08/2003
 *
...
/**
 * The implementation of a XUI SaveFileDialog. allows the user to graphically choose a directory
 * to save a file to and then save out to that file. If any listeners are registered with this
 * component they will be given a reference to the file.
 *
 * @version 0.5 18/08/2003
 * @author  Arron Ferguson
 */
public class XUISaveFileDialogImpl implements XUISaveFileDialog, ActionListener
{
    /**
    ...
    static
    {
        ...
        supportedComponents.add("No supported types for SaveFileDialog.");
    }
     ...
     */
    public XUISaveFileDialogImpl(XUINode node) throws XUIDisplayException
    {
        ...
        if(!(node.getName().equals("SaveFileDialog")))
            throw new XUIDisplayException("Node for XUISaveFileDialog must be named 'SaveFileDialog' and conform to the XUI schema.");
     ...
     */
    public XUISaveFileDialogImpl()
    {

        // now create the XML version of this element
        dialogNode = new XUINodeImpl("SaveFileDialog");
     ...
     */
    public XUISaveFileDialogImpl(XUIWindow parent, String name) throws XUIDisplayException
    {
        this();
        if(name == null)
    ...
    public void visualize()
    {
        ...
        if(Boolean.valueOf(dialogNode.getAttributeValue("visible")).booleanValue())
            dialog.showSaveDialog(window.getPeer());
    }
