...
/**
 * @(#)XUITextFieldImpl.java    0.5 18/08/2003
 *
...
/**
 * The implementation of the XUITextField interface.
 *
 * @version 0.5 18/08/2003
 * @author  Arron Ferguson
 */
public class XUITextFieldImpl implements XUITextField, ActionListener
{
    ...
    /**
     * <p>Constructs a new XUITextField implementation and passing it its XML node rather than requiring
     * the XUITextField implementation to build it from scratch. This method is called by the Realizer
     ...
     * This constructor is required when creating a XUI text field where the node has already been built
     ...
     */
    public XUITextFieldImpl(XUINode node) throws XUIDisplayException
    {
        ...
        if(!(node.getName().equals("TextField")))
            throw new XUIDisplayException("Node for XUITextField must be named 'TextField' and conform to the XUI schema.");
        else
        {
            // gui component
    ...
    /**
     * Creates a field. Default size is 1 x 1 cells in the top left corner.
     */
    public XUITextFieldImpl()
    {
        // gui component
        field = new JTextField(15);

        // create the XML node representing this component.
        fieldNode = new XUINodeImpl("TextField");
        ...
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "id", "id", "xs:ID",
            IDFactory.getInstance().generateID("textfield"));
    ...
    /**
     * Creates a text field and gives it x and y coordinates. If the text field has a parent,
     * then the text field will be placed at that position. The x and y values must be within the XUI
     ...
     */
    public XUITextFieldImpl(int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        this();
