...
/**
 * @(#)XUIPasswordFieldImpl.java    0.5 18/08/2003
 *
 ...
 */
public class XUIPasswordFieldImpl implements XUIPasswordField, ActionListener
{
    /**
    ...
    /**
     * <p>Constructs a new XUIPasswordField implementation and passing it its XML node rather than requiring
     * the XUIPasswordField implementation to build it from scratch. This method is called by the Realizer
     ...
     * This constructor is required when creating a XUI password field where the node has already been built
     ...
     */
    public XUIPasswordFieldImpl(XUINode node) throws XUIDisplayException
    {
        ...
        if(!(node.getName().equals("PasswordField")))
            throw new XUIDisplayException("Node for XUIPasswordField must be named 'PasswordField' and conform to the XUI schema.");
        else
        {
            // gui component
     ...
     */
    public XUIPasswordFieldImpl()
    {
        // gui component
        field = new JPasswordField(15);

        // create the XML node representing this component.
        fieldNode = new XUINodeImpl("PasswordField");
        ...
        fieldNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "id", "id", "xs:ID",
            IDFactory.getInstance().generateID("field"));
    ...
    /**
     * Creates a password field and gives it x and y coordinates. If the password field has a parent,
     * then the password field will be placed at that position. The x and y values must be within the XUI
     ...
     */
    public XUIPasswordFieldImpl(int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        this();
        ...
        else
        {
            ...
            if(parent != null)
            {
                ...
                else
                {
                    ...
                    container.add(field, new Rectangle(gridY, gridX, gridWidth, gridHeight));
                    field.invalidate();
                    container.validate();
