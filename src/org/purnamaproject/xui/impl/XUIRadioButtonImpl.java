...
/**
 * @(#)XUIRadioButtonImpl.java  0.1 18/08/2003
 *
 ...
 */
public class XUIRadioButtonImpl implements XUIRadioButton, ActionListener
{
    /**
    ...
    /**
     * <p>Constructs a new XUIRadioButton implementation and passing it its XML node rather than requiring
     * the XUIRadioButton implementation to build it from scratch. This method is called by the Realizer
     ...
     * This constructor is required when creating a XUI Radio Button where the node has already been built
     ...
     */
    public XUIRadioButtonImpl(XUINode node) throws XUIDisplayException
    {
        ...
        if(!(node.getName().equals("RadioButton")))
            throw new XUIDisplayException("Node for XUIRadioButton must be named 'RadioButton' and conform to the XUI schema.");
        else
        {
            // gui component
            ...
            button.setSelected(Boolean.valueOf(node.getAttributeValue("selected")).booleanValue());
    ...
    /**
     * Creates a radio button with no label or image. Default size is 1 x 1 cells in the
     * top left corner.
     */
    public XUIRadioButtonImpl()
    {
        // gui component
        button = new JRadioButton();
        ...
        buttonNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "orientation", "orientation", "xs:token",
            "horizontal");
        buttonNode.addAttribute("http://xml.bcit.ca/PurnamaProject/2003/xui", "selected", "selected", "xs:boolean",
            "false");
    }

    /**
     * Creates a radio button with an image and gives it x and y coordinates. If the radio button has a parent,
     * then the radio button will be placed at that position. The x and y values must be within the XUI
     ...
     */
    public XUIRadioButtonImpl(XUIImage image, int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        this();
    ...
    /**
     * Creates a radio button with a label and places it at the x and y coordinate. If the radio button has a parent,
     * then the radio button will be placed at that position. The x and y values must be within the XUI
     * schema specification as well, be placed on the panel and not overtop of any other component.
     * If so, an exception is generated.
     *
     ...
     */
    public XUIRadioButtonImpl(String label, int xCoordinate, int yCoordinate) throws XUIDisplayException
    {
        this();
     ...
     * @param yCoordinate the y coordinate used to place the button on the grid.
     */
    public XUIRadioButtonImpl(String label, XUIImage image, int xCoordinate, int yCoordinate)
    ...
    {
        if(newLabel == null)
            throw new XUITypeFormatException("Label for XUIRadioButton cannot be null.");
        else
        {
